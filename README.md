# 该文章中使用的是插桩式方法实现动态加载activity，不能解决activity继承至AppCompatActivity的一系列，于是写了一版通过Hook的方式动态加载插件apk的demo，详情见 [传送门](https://github.com/stray-coding/HookActivity/tree/master)
